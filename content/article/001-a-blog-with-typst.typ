...
#image("/public/images/article/env/blog/001.png")
...
#image("/public/images/article/env/blog/002.png")
...
- 顺便贴一张我正在使用的截图：
#image("/public/images/article/env/blog/003.jpg")
...
#image("/public/images/article/env/blog/004.jpg")
如上图所示，我创建了一个叫`blog`的文件夹。

- 右键点击，打开"Git Bash Here"。
#image("/public/images/article/env/blog/005.jpg")

- 然后去之前提及的模板开源库或我的仓库中克隆项目：
  // ```bash
  // git clone https://github.com/Myriad-Dreamin/tylant.git
  // ```
  #image("/public/images/article/env/blog/006.png")
  复制该地址，终端输入：
  ```bash
  git clone https://github.com/Myriad-Dreamin/tylant.git
  ```
...
```
#image("/public/images/article/env/blog/008.jpg")
...
#image("/public/images/article/env/blog/009.png")
...
#image("/public/images/article/env/blog/010.png")
...
+ 权限错误
  ...
  #image("/public/images/article/env/blog/011.png")
